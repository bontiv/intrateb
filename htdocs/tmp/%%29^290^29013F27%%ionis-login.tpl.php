<?php /* Smarty version 2.6.26, created on 2013-08-10 18:37:06
         compiled from ionis-login.tpl */ ?>
...
<button style="float:right;" class="btn" type="submit" value="Etape suivante" name="next">Vérification</button>
    
    <button class="btn" type="submit" value="Annuler ce groupe" name="previous">Annuler ce groupe</button></p>
</form>
