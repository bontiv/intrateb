...
<p>
  ...
  <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
      <li>
        <a href="{mkurl action="admin_note" page="downbulletin" format="hoarau" id=$bulletin->period_id}">Format CSV hoarau</a>
      </li>
      <li>
        <a href="{mkurl action="admin_note" page="downbulletin" format="intra" id=$bulletin->period_id}">Format CSV Intra</a>
      </li>
    </ul>
  </div>
...
{if $bulletin->raw_period_state=="VALID"}
    <a class="btn btn-success" href="{mkurl action="admin_note" page="validbulletin" id=$bulletin->period_id}"><div class="glyphicon glyphicon-ok"></div> Envoyer</a>
{/if}
