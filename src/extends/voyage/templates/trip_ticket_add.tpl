...
<ol class="breadcrumb">
  ...
  <li><a href="{mkurl action="trip" page="admin_tickets" trip=$trip->tr_id}">Types billet</a></li>
  <li class="active">Ajout</li>
</ol>

<h1>Gestion Voyage <small>{$trip->tr_name|escape}</small></h1>
<h2>Ajout d'un type de billet</h2>

<form action="{mkurl action="trip" page="ticket_add" trip=$trip->tr_id}" method="POST" class="form-horizontal">
  <fieldset>
    {$form}
  </fieldset>
  <fieldset>
