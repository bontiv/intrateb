...
<h2>Modification transport <small>{$car->tc_name|escape}</small></h2>

<form action="{mkurl action="trip" page="car_edit" car=$car->tc_id}" method="POST" class="form-horizontal">
  <fieldset>
    {$form}
  </fieldset>
  <fieldset>
